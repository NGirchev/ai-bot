...
/**
 * Настройки обновления списка free-моделей OpenRouter.
 *
 * Важно: без дефолтов в коде, всё задаётся в application.yml.
 */
@ConfigurationProperties(prefix = "ai-bot.common.openrouter-free-models")
@Validated
@Getter
@Setter
public class OpenRouterFreeModelsProperties {

    /**
     * Включить/выключить фоновое обновление и резолвинг "openrouter/auto" в free-модель.
     */
