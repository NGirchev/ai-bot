...
class SpringAIModelTypeTest {
    ...
    private SpringAIModelConfig createModel(String name, List<ModelType> capabilities, SpringAIModelConfig.ProviderType providerType, Integer priority) {
    ...
    void whenGetByCapability_unsupportedType_thenReturnEmpty() {
        ...
        ModelType unsupportedType = ModelType.RERANK;
        SpringAIModelType springAIModelType = createSpringAIModelType();
    ...
    void whenGetByCapability_MODERATION_thenReturnEmpty() {
        // Arrange
        ModelType moderationType = ModelType.MODERATION;
        SpringAIModelType springAIModelType = createSpringAIModelType();
    ...
    void whenGetByCapability_STRUCTURED_OUTPUT_thenReturnEmpty() {
        // Arrange
        ModelType structuredOutputType = ModelType.STRUCTURED_OUTPUT;
        SpringAIModelType springAIModelType = createSpringAIModelType();
    ...
    void whenGetByCapability_TOOL_CALLING_thenReturnEmpty() {
        // Arrange
        ModelType toolCallingType = ModelType.TOOL_CALLING;
        SpringAIModelType springAIModelType = createSpringAIModelType();
    ...
    void whenGetByCapability_RAW_TYPE_thenReturnEmpty() {
        // Arrange
        ModelType rawType = ModelType.RAW_TYPE;
        SpringAIModelType springAIModelType = createSpringAIModelType();
